...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Api)\n/* harmony export */ });\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"../node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n\r\n\r\nclass Api {\r\n  static async get(url, headers) {\r\n    const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(url, {headers});\r\n    const data = response.data;\r\n    return data;\r\n  }\r\n}\r\n\n\n//# sourceURL=webpack:///./api/api.js?");

/***/ }),

/***/ "./favorite/add-to-favorite.js":
/*!*************************************!*\
  !*** ./favorite/add-to-favorite.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ ImagesModel)\n/* harmony export */ });\nclass ImagesModel {\r\n  constructor () {\r\n    this._images = [];\r\n  }\r\n\r\n  getImages() {\r\n    return this._images;\r\n  }\r\n\r\n  setImages(images) {\r\n    this._images = this._images.concat(images);\r\n  }\r\n}\r\n\n\n//# sourceURL=webpack:///./imagesModel/imagesModel.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_index_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/index.scss */ \"./styles/index.scss\");\n/* harmony import */ var _api_api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./api/api */ \"./api/api.js\");\n/* harmony import */ var _view_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./view/view */ \"./view/view.js\");\n/* harmony import */ var _imagesModel_imagesModel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./imagesModel/imagesModel */ \"./imagesModel/imagesModel.js\");\n/* harmony import */ var _utils_const__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/const */ \"./utils/const.js\");\n/* harmony import */ var _favorite_add_to_favorite__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./favorite/add-to-favorite */ \"./favorite/add-to-favorite.js\");\n\r\n\r\n\r\n\r\n\r\n\r\nconst footer = document.querySelector('.footer');\r\nconst footerText = document.querySelector('.footer__text');\r\nconst content = document.querySelector('.main__content');\r\nconst favorite = document.querySelector('.favorite-item');\r\nconst allItem = document.querySelector('.all-item');\r\n\r\nlet nextPage = 1;\r\nconst ImgView = new _view_view__WEBPACK_IMPORTED_MODULE_2__[\"default\"]()\r\nconst ImageModel = new _imagesModel_imagesModel__WEBPACK_IMPORTED_MODULE_3__[\"default\"];\r\n\r\nallItem.addEventListener('click', showAllImages);\r\nfavorite.addEventListener('click', showFavorites);\r\n\r\nfunction showFavorites(event) {\r\n  event.preventDefault();\r\n  footer.innerHTML='';\r\n  allItem.classList.remove('header-item--active');\r\n  favorite.classList.add('header-item--active');\r\n  const imagesLocalStorage = (0,_favorite_add_to_favorite__WEBPACK_IMPORTED_MODULE_5__.getFavoriteImages)();\r\n  if(imagesLocalStorage.length === 0){\r\n    content.innerHTML = `<div>У вас еще нет любимых котиков!</div>`\r\n  } else {\r\n    ImgView.renderImg (imagesLocalStorage, content)\r\n  }\r\n}\r\n\r\nfunction showAllImages(evt) {\r\n  evt.preventDefault();\r\n  favorite.classList.remove('header-item--active');\r\n  allItem.classList.add('header-item--active');\r\n  ImgView.renderImg((ImageModel.getImages()), content);\r\n  footer.append(footerText);\r\n  imageObserver.observe(footerText);\r\n}\r\n\r\nconst imageObserver = new IntersectionObserver (\r\n  ([entry], observer) => {\r\n    async function getData () {\r\n      return await _api_api__WEBPACK_IMPORTED_MODULE_1__[\"default\"].get(_utils_const__WEBPACK_IMPORTED_MODULE_4__.CatsRequest.BASEURL + `&page=${nextPage}`, _utils_const__WEBPACK_IMPORTED_MODULE_4__.CatsRequest.HEADERS);    }\r\n    getData()\r\n    .then((data => ImageModel.setImages(data)))\r\n    .then(() => ImgView.renderImg((ImageModel.getImages()), content))\r\n    .then(() => nextPage++)\r\n  },\r\n);\r\nimageObserver.observe(footerText);\r\n\n\n//# sourceURL=webpack:///./index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ View)\n/* harmony export */ });\n/* harmony import */ var _favorite_add_to_favorite__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../favorite/add-to-favorite */ \"./favorite/add-to-favorite.js\");\n\r\n\r\n\r\n\r\nclass View {\r\n  renderImg(data, container) {\r\n    const favoriteImages = (0,_favorite_add_to_favorite__WEBPACK_IMPORTED_MODULE_0__.getFavoriteImages)();\r\n    container.innerHTML = '';\r\n    data.forEach(element => {\r\n      const isFavorite = favoriteImages.some(image => image.url === element.url)\r\n      const component = createImgElement(element.url, isFavorite);\r\n      container.append(component);\r\n    });\r\n  }\r\n}\r\nconst createImgElement = (template, isFavorite) => {\r\n  const newElement = document.createElement(`div`);\r\n  newElement.classList.add('main__image');\r\n  const image = new Image();\r\n  image.src = template;\r\n  newElement.append(image)\r\n  createButton(newElement, isFavorite);\r\n  return newElement\r\n};\r\n\r\nconst createButton = (element, isFavorite) => {\r\n  const button = document.createElement(`button`);\r\n  button.setAttribute('type', 'button');\r\n  isFavorite ? button.classList.add('favorite', 'main__button', 'localStorage') : button.classList.add('main__button');\r\n  button.classList.add('main__button');\r\n  button.addEventListener('click', _favorite_add_to_favorite__WEBPACK_IMPORTED_MODULE_0__.toggleLocalStorage)\r\n  element.append(button);\r\n  return element;\r\n}\r\n\n\n//# sourceURL=webpack:///./view/view.js?");
